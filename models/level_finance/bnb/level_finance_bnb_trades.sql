...
{% set project_start_date = '2022-12-09' %}
-- Pool deployment date https://bscscan.com/tx/0xfe8d8cfc38c90302059a423d12e57405bc1730c9c8052a31f5d816a5b16e6db3
...
(
    SELECT
        ...
        ,t.evt_index
    FROM
        {{ source('level_finance_bnb', 'Pool_evt_Swap') }} t
    {% if is_incremental() %}
